...
def main(argv=None):
    ...
    goal_train = commands.add_parser("train-goal-interface", help="train observed-context dual features or legacy goal/visual stages")
    goal_train.add_argument("--config", required=True)
    goal_train.add_argument("--index", required=True)
    goal_train.add_argument("--stage", required=True, choices=("goal", "visual", "joint"))
